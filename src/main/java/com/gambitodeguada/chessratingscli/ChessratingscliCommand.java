...
public class ChessratingscliCommand implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        PicocliRunner.run(ChessratingscliCommand.class, args);
    }

    public void run() {
        List<FidePlayer> ratedPlayers = fetchPlayerRatings(players);
        ratedPlayers.sort(COMPARATOR);
        System.out.println(markdownTable(ratedPlayers));
    }
